<?php 
   ...
   /*$consulta=mysqli_query($conn, 
    ...
    $consulta=mysqli_query($conn, 
            ...
            "SELECT * FROM tabla_operaciones WHERE realizado != 'si'  AND  (zona = 4 OR zona = 1)");
                        ...
                        <div class="box_activos">
                             <div class="sel_barco">
                               ...
                               <div class="link_ver_barco"> 
                                  <a href="barcos_activos.php?servicio=pluma" class="boton" id="'.$res['id_barco'].'&id_op='.$id_op.'" onClick="buscar('.$res['id_barco'].','.$id_op.');"><i class="material-icons">send</i>
                                  </a>  
                                </div>
                          </div>'; }                                   
