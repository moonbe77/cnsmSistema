    ...
    if (empty($_POST['usuario_nick']) || empty($_POST['usuario_clave'])) { 
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            while($row = mysqli_fetch_assoc($result)) {
                ...
                $mensaje ="logOK" ;//paso este emensaje para que el script confirme el login OK
            ...
            //Registro de la operación
                ...
                //update de la sesion a todos los usuarios en la BD
                $sqlSession= "UPDATE usuarios set s_id = '$s_id' ";

                if (mysqli_query($conn, $sqlSession)) {
                    //echo "New record created successfully";
                } else {
                    echo "Error: " . $sqlSession . "<br>" . mysqli_error($conn);
                }
            }
